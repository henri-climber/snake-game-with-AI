...
def main():
    ...
    while run:
        ...
        old_facing = snake_head.facing

        if key[pygame.K_UP] and old_facing != "down":
            snake_head.facing = "up"
        elif key[pygame.K_LEFT] and old_facing != "right":
            snake_head.facing = "left"
        elif key[pygame.K_DOWN] and old_facing != "up":
            snake_head.facing = "down"
        elif key[pygame.K_RIGHT] and old_facing != "left":
